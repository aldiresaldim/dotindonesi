        ...
        @endif
								...
								@csrf
                                   ...
                                   <div class="mt-3">
                                        ...
                                        <input name="kode_kategori" autofocus required id="regular-form-1" type="text" class="form-control" placeholder="">
                                    </div>
                                       <div class="mt-3">
                                        <label for="regular-form-1" class="form-label">Nama Kategori</label>
                                        <input name="nama_kategori" autofocus required id="regular-form-1" type="text" class="form-control" placeholder="">
                                    </div>
